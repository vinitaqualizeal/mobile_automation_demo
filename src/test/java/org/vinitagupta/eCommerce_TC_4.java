...
public class eCommerce_TC_4 extends BaseClass {
        ...
        public void FillForm() throws InterruptedException
        {
            ...
            Thread.sleep(7000); //added wait for loading the webview
            ...
            driver.findElement(By.name("q")).sendKeys("Vinita Gupta");
            driver.findElement(By.name("q")).sendKeys(Keys.ENTER);
            driver.pressKey(new KeyEvent(AndroidKey.BACK));
            driver.context("NATIVE_APP");
            //Hybrid - Google page->

            String homePageTitle = driver.findElement(By.id("com.androidsample.generalstore:id/toolbar_title")).getText();
